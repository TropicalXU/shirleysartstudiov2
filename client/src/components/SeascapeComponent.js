...
const Seascape = (props) => {
    ...
    const seascapePaintings = props.paintings.map((painting, index) => {
        if(painting.type === 'seascape' && painting.isAvailable === true) {
            return (
        ...
        else if(painting.type === 'seascape' && painting.isAvailable === false) {
            return (
                <div key={painting.id.toString()} className='col-12 col-md-6 col-lg-4 text-center py-3'>
                    <RenderPaintings item={painting} />
        ...
        <div className='row-lt-grey pb-5'>
            <div className='container tabs'>
                ...
                <div className='row d-flex justify-content-center text-center py-5 mx-2'>
                    ...
                    <div className='col-12 col-md-3 options-tab-active py-2 mx-2 my-2'>
                        <Link to='/gallery/seascape' className='btn btn-services btn-services-active font-two ml-1'>SEASCAPE</Link>  
                    </div>
                    <div className='col-12 col-md-3 options-tab py-2 my-2'>
